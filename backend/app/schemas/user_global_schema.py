...
class UserGlobalModel(BaseModel):
    ...
    username: str = Field(
        ..., title="Username", description="Unique username for the user."
    )
...
class UserGlobalUpdate(BaseModel):
    ...
    username: Optional[str] = Field(
        None, title="Username", description="Unique username for the user."
    )
    ...
    email: Optional[EmailStr] = Field(
        None, title="Email", description="User's email address."
    )
